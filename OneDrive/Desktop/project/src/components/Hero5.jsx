...
const Hero5 = () => {
  ...
  const [predictionResult, setPredictionResult] = useState(""); // For displaying prediction
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Capture the genre prediction from the response
      setPredictionResult(response.data.genre_prediction); // Correctly access genre prediction
    } catch (error) {
