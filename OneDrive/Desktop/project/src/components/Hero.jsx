    ...
    const onSubmit = async (data) => {
      ...
      if (file) {
        ...
        try {
          ...
          // Handle the response here (e.g., display the predicted genre)
        } catch (error) {
            ...
            <div className="relative max-w-[23rem]
             mx-auto md:max-w-5xl xl:mb-24">
                ...
                <div className="relative z-1
                 p-0.5 rounded-2xl bg-conic-gradient">

                    <div className="relative bg-n-8
                     rounded-[1rem]">

                        <div className="h-[1.4rem]
                         bg-n-10 rounded-t-[0.9rem]"/> 
                            ...
                            scale-[1.7] translate-y-[8%]
                             md:scale-[1] md:-translate-y-[10%]
                              lg:-translate-y-[23%]"
                                ...
                                right-4 bottom-5 md:left-1/2 md:right-auto
                                 ...
                                 <form  onSubmit={handleSubmit(onSubmit)}> 
                                    ...
                                    <input 
                                     ...
                                     type="file"
                                      name="music"
                                      accept="audio/*"
                                      onChange={handleFileChange} ref={fileInputField}
                                       />

                                 <Button
                                 className="px-12 py-6 rounded-lg mt-4" 
                 ...
                 left-1/2 w-[234%] -translate-x-1/2
                  md:-top-[46%] md:w-[138%]
                   lg:-top-[104%]">
                ...
                <Companylogos className="hidden relative 
                z-10 mt-20 lg:block" />
